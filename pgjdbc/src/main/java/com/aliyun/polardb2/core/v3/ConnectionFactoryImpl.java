...
import com.aliyun.polardb2.hostchooser.CandidateHost;
import com.aliyun.polardb2.hostchooser.GlobalHostStatusTracker;
import com.aliyun.polardb2.hostchooser.HostChooser;
import com.aliyun.polardb2.hostchooser.HostChooserFactory;
import com.aliyun.polardb2.hostchooser.HostRequirement;
import com.aliyun.polardb2.hostchooser.HostStatus;
...
import com.aliyun.polardb2.util.MD5Digest;
import com.aliyun.polardb2.util.PSQLException;
import com.aliyun.polardb2.util.PSQLState;
import com.aliyun.polardb2.util.ServerErrorMessage;
...
public class ConnectionFactoryImpl extends ConnectionFactory {
  ...
  private ISSPIClient createSSPI(PGStream pgStream,
    ...
    try {
      ...
      Class<ISSPIClient> c = (Class<ISSPIClient>) Class.forName("com.aliyun.polardb2.sspi.SSPIClient");
      ...
      throw new IllegalStateException("Unable to load com.aliyun.polardb2.sspi.SSPIClient."
      ...
      case 'G':
        ...
        try {
          AuthenticationPluginManager.withPassword(AuthenticationRequestType.GSS, info, password -> {
            com.aliyun.polardb2.gss.MakeGSS.authenticate(true, pgStream, host, user, password,
  ...
  private PGStream enableSSL(PGStream pgStream, SslMode sslMode, Properties info,
    ...
    switch (beresp) {
      ...
      case 'S':
        ...
        // Server supports ssl
        com.aliyun.polardb2.ssl.MakeSSL.convert(pgStream, info);
        return pgStream;
            ...
            switch (areq) {
              ...
              case AUTH_REQ_SSPI:
                ...
                if (useSSPI) {
                  ...
                  AuthenticationPluginManager.withPassword(AuthenticationRequestType.GSS, info, password -> {
                    com.aliyun.polardb2.gss.MakeGSS.authenticate(false, pgStream, host, user, password,
                        PGProperty.JAAS_APPLICATION_NAME.getOrDefault(info),
   ...
   * {@link com.aliyun.polardb2.hostchooser.HostRequirement#secondary}.
