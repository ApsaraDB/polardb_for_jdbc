...
public abstract class QueryExecutorBase implements QueryExecutor {
  ...
  @SuppressWarnings({"assignment.type.incompatible", "argument.type.incompatible", "method.invocation.invalid"})
   ...
   * @see com.aliyun.polardb2.PGConnection#getParameterStatuses
   * @see com.aliyun.polardb2.PGConnection#getParameterStatus
   */
