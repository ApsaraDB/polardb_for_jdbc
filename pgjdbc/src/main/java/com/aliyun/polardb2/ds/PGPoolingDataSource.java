...
package com.aliyun.polardb2.ds;

import static com.aliyun.polardb2.util.internal.Nullness.castNonNull;

import com.aliyun.polardb2.ds.common.BaseDataSource;
...
public class PGPoolingDataSource extends BaseDataSource implements DataSource {
  ...
  public String getDescription() {
    return "Pooling DataSource '" + dataSourceName + " from " + com.aliyun.polardb2.util.DriverInfo.DRIVER_FULL_NAME;
  }
