...
package com.aliyun.polardb2.ds.common;
...
public abstract class BaseDataSource implements CommonDataSource, Referenceable {
  ...
  static {
    try {
      ...
      throw new IllegalStateException(
        "BaseDataSource is unable to load com.aliyun.polardb2.Driver. Please check if you have proper PostgreSQL JDBC Driver jar on the classpath",
        e);
    }
  }
  ...
  public void setUrl(String url) {
    ...
    Properties p = com.aliyun.polardb2.Driver.parseURL(url, null);
  ...
  /**
   *
   * @param className name of a class which implements {@link com.aliyun.polardb2.plugin.AuthenticationPlugin}
  ...
  public java.util.logging.Logger getParentLogger() {
    return Logger.getLogger("com.aliyun.polardb2");
  }
  ...
  public void setNlsLocaleInit(String nlsLocaleInit) {
    PGProperty.NLS_LOCALE_INIT.set(properties, nlsLocaleInit);
  }
