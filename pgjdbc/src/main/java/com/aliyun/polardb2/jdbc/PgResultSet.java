...
import com.aliyun.polardb2.core.Encoding;
...
public class PgResultSet implements ResultSet, com.aliyun.polardb2.PGRefCursorResultSet {
  ...
  public java.net.URL getURL(@Positive int columnIndex) throws SQLException {
    ...
    checkClosed();
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getURL(int)");
  }
  ...
  public @Nullable Object getObjectImpl(
    ...
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getObjectImpl(int,Map)");
  }
  ...
  public @Nullable Ref getRef(int i) throws SQLException {
    ...
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getRef(int)");
  }
  ...
  public void updateRef(@Positive int columnIndex, @Nullable Ref x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateRef(int,Ref)");
  }

  public void updateRef(String columnName, @Nullable Ref x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateRef(String,Ref)");
  }

  public void updateBlob(@Positive int columnIndex, @Nullable Blob x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateBlob(int,Blob)");
  }

  public void updateBlob(String columnName, @Nullable Blob x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateBlob(String,Blob)");
  }

  public void updateClob(@Positive int columnIndex, @Nullable Clob x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateClob(int,Clob)");
  }

  public void updateClob(String columnName, @Nullable Clob x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateClob(String,Clob)");
  }
  ...
  public void updateObject(@Positive int columnIndex, @Nullable Object x, java.sql.SQLType targetSqlType,
    ...
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateObject");
  }
  ...
  public @Nullable RowId getRowId(@Positive int columnIndex) throws SQLException {
    ...
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getRowId(int)");
  }
  ...
  public void updateRowId(@Positive int columnIndex, @Nullable RowId x) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateRowId(int, RowId)");
  }
  ...
  public int getHoldability() throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getHoldability()");
  }
  ...
  public void updateNString(@Positive int columnIndex, @Nullable String nString) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateNString(int, String)");
  }
  ...
  public void updateNClob(@Positive int columnIndex, @Nullable NClob nClob) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateNClob(int, NClob)");
  }
  ...
  public void updateNClob(@Positive int columnIndex, @Nullable Reader reader) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateNClob(int, Reader)");
  }
  ...
  public void updateNClob(@Positive int columnIndex, @Nullable Reader reader, long length) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateNClob(int, Reader, long)");
  }
  ...
  public @Nullable NClob getNClob(@Positive int columnIndex) throws SQLException {
    ...
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getNClob(int)");
  }
  ...
  public void updateBlob(@Positive int columnIndex, @Nullable InputStream inputStream, long length)
      throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(),
  ...
  public void updateBlob(@Positive int columnIndex, @Nullable InputStream inputStream) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateBlob(int, InputStream)");
  }
  ...
  public void updateClob(@Positive int columnIndex, @Nullable Reader reader, long length) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateClob(int, Reader, long)");
  }
  ...
  public void updateClob(@Positive int columnIndex, @Nullable Reader reader) throws SQLException {
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "updateClob(int, Reader)");
  }
  ...
  public @Nullable Reader getNCharacterStream(@Positive int columnIndex) throws SQLException {
    ...
    throw com.aliyun.polardb2.Driver.notImplemented(this.getClass(), "getNCharacterStream(int)");
  }
