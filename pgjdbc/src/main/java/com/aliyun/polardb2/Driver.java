...
import com.aliyun.polardb2.util.PGPropertyUtil;
import com.aliyun.polardb2.util.PSQLException;
import com.aliyun.polardb2.util.PSQLState;
import com.aliyun.polardb2.util.SharedTimer;
 ...
 *
 * @see com.aliyun.polardb2.PGConnection
 * @see java.sql.Driver
 */
public class Driver implements java.sql.Driver {

  private static @Nullable Driver registeredDriver;
  private static final Logger PARENT_LOGGER = Logger.getLogger("com.aliyun.polardb2");
  private static final Logger LOGGER = Logger.getLogger("com.aliyun.polardb2.Driver");
   ...
   *
   * <pre>
   *  jdbc:polardb://host:port/database?param1=val1&amp;...
   * </pre>
   *
  ...
  public @Nullable Connection connect(String url, @Nullable Properties info) throws SQLException {
    ...
    try {
      ...
      // com.aliyun.polardb2.unusual error will be returned instead.
      throw ex1;
    } catch (Exception ex2) {
  ...
  private static Connection makeConnection(String url, Properties props) throws SQLException {
    ...
    if (conn.getDriverPrefix() == PolarDriverPrefix.POSTGRES && !conn.isForceDriverType()) {
      return null;
    }
   ...
   * don't. Our protocols start with jdbc:polardb:
   *
  ...
  public int getMajorVersion() {
    return com.aliyun.polardb2.util.DriverInfo.MAJOR_VERSION;
  }

  @Override
  public int getMinorVersion() {
    return com.aliyun.polardb2.util.DriverInfo.MINOR_VERSION;
  }
