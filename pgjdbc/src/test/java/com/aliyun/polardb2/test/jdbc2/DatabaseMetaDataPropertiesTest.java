...
/*
 * TestCase to test the internal functionality of com.aliyun.polardb2.jdbc2.DatabaseMetaData's various
...
public class DatabaseMetaDataPropertiesTest {
  ...
  public void testDbProductDetails() throws SQLException {
    assertTrue(con instanceof com.aliyun.polardb2.PGConnection);
