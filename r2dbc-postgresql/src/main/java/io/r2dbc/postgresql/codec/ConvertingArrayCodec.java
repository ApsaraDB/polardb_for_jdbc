...
final class ConvertingArrayCodec<T> extends ArrayCodec<T> implements PreferredCodec {
    ...
    static final Set<PostgresqlObjectId> DATE_ARRAY_TYPES = EnumSet.of(DATE_ARRAY, TIMESTAMP_ARRAY, TIMESTAMPTZ_ARRAY, TIME_ARRAY, TIMETZ_ARRAY, POLARDB_DATE_ARRAY);
